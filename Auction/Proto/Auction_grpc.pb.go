...
const (
	...
	Auction_GetPrimaryServer_FullMethodName = "/Auction.Auction/getPrimaryServer"
)
...
type AuctionClient interface {
	...
	GetPrimaryServer(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ServerResponse, error)
}
...
func (c *auctionClient) GetPrimaryServer(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ServerResponse, error) {
	out := new(ServerResponse)
	err := c.cc.Invoke(ctx, Auction_GetPrimaryServer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuctionServer interface {
	...
	GetPrimaryServer(context.Context, *Empty) (*ServerResponse, error)
...
func (UnimplementedAuctionServer) GetPrimaryServer(context.Context, *Empty) (*ServerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPrimaryServer not implemented")
}
...
func _Auction_GetPrimaryServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuctionServer).GetPrimaryServer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auction_GetPrimaryServer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServer).GetPrimaryServer(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auction_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "getPrimaryServer",
			Handler:    _Auction_GetPrimaryServer_Handler,
		},
	},
