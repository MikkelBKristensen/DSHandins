...
const (
	HelloService_SayHi_FullMethodName = "/proto.HelloService/SayHi"
)
...
func (c *helloServiceClient) SayHi(ctx context.Context, in *Greeting, opts ...grpc.CallOption) (*Farewell, error) {
	out := new(Farewell)
	err := c.cc.Invoke(ctx, HelloService_SayHi_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloServiceServer) SayHi(context.Context, *Greeting) (*Farewell, error) {
...
func _HelloService_SayHi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).SayHi(ctx, req.(*Greeting))
	}
