...
type MeServiceClient interface {
	ConnectionStatus(ctx context.Context, in *ConnectionMsg, opts ...grpc.CallOption) (*Message, error)
...
func (c *meServiceClient) ConnectionStatus(ctx context.Context, in *ConnectionMsg, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
...
type MeServiceServer interface {
	ConnectionStatus(context.Context, *ConnectionMsg) (*Message, error)
...
func (UnimplementedMeServiceServer) ConnectionStatus(context.Context, *ConnectionMsg) (*Message, error) {
